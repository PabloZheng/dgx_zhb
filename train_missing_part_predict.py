...
def main():
    ...
    dataset_train = torchvision.datasets.ImageFolder(os.path.join(data_root, 'train'), train_transforms)
    ...
    val_set = torchvision.datasets.ImageFolder(os.path.join(data_root, 'val'), val_transform)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--num_classes", default=5, type=int, help="Class num for your task.")
    parser.add_argument("--dropout", default=0.0, type=float, help="Dropout rate.")
    parser.add_argument("--log_path", default='./logs/exp1', type=str, help="Path for saving logs")
    parser.add_argument("--pth_path", default='./runs/exp1', type=str, help="Path for saving pth")
